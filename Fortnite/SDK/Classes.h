...
public:
	...
	EFortItemTier Tier()
	{
		return *(EFortItemTier*)(this + 0xEB);
	}
};
...
public:
	...
	{
		return *(EFortWeaponCoreAnimation*)(this + 0x12c8);
	}

	int AmmoCount()
	{
		return *(int*)(this + 0x318);
	}

	float LastFireAbilityTime()
	{
		return *(float*)(this + 0x1174);
	}
...
public:
	...
	{
		return *(TArray<USkeletalMeshComponent*>*)(this + 0x5c70);//0x5c60 540
	}

	TArray<UMaterialInstanceDynamic*> PawnMaterials_ALL()
	{
		return *(TArray<UMaterialInstanceDynamic*>*)(this + 0x5c80);//0x4ba0
	}
};
...
public:
	...
	{
		return *(UFortProjectileMovementComponent**)(this + 0x780);
	}
